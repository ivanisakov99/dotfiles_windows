...
function Test-PowershellShortcut {
  [CmdletBinding()]
  param (
...
function Reset-PowerShellShortcut {
  ...
  if (Test-PowershellShortcut $Path) {
...
Export-ModuleMember -Function Reset-AllPowerShellShortcuts, Reset-AllBashShortcuts
...
Export-ModuleMember -Function Convert-ConsoleColor

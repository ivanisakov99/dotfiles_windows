...
# Change the location of PowerShell profiles
# Set-ItemProperty
New-ItemProperty "HKCU:\SOFTWARE\Microsoft\Windows\CurrentVersion\Explorer\User Shell Folders" Personal -Value "C:\Users\$env:UserName\Documents" -Type ExpandString -Force
